      ...
      /*'formatter' => [
        ...
        'attributes' => [
            [
              ...
              'format' => 'raw',
              'value' => ( existeTituloProjeto($model) ? Html::a(($model->titulo_projeto!='' ? $model->titulo_projeto : 'Anexo') . ' <i class="fas fa-paperclip" ></i>', ['downloadtitulo', 'id' => $model->id] ) . Html::a(existeTituloProjeto($model) ? '| <i class="fa fa-close" ></i> Excluir anexo' : '', ['deletetitulo', 'id' => $model->id] ) : '' ),
            ],
            'nome_coordenador',
            'num_processo',
            'num_protocolo',
            [
              ...
              'label' => 'Edital',
              'format' => 'raw',
              'value' => (existeEdital($model) ? Html::a(($model->edital!='' ? $model->edital : 'Anexo') . ' <i class="fas fa-paperclip" ></i>', ['downloadedital', 'id' => $model->id] ) . Html::a(existeEdital($model) ? '| <i class="fa fa-close" ></i> Excluir anexo' : '', ['deleteedital', 'id' => $model->id] ) : ''),
            ],
